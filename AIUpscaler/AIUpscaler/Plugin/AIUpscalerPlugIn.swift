//
//  AIUpscalerPlugIn.swift
//  AIUpscaler
//
//  Created by Regis Araujo Melo on 05/06/26.
//

@objc(AIUpscalerPlugIn) class AIUpscalerPlugIn : NSObject, FxTileableEffect {
    ...
    func renderDestinationImage(_ destinationImage: FxImageTile, sourceImages: [FxImageTile], pluginState: Data?, at renderTime: CMTime) throws {
        ...
        commandBuffer.label = "AIUpscaler Command Buffer"
